    ...
    <ScreenWrapper className="pb-4">
      ...
      <View className="flex-row items-center justify-between my-3">
        <View className="flex-row items-center gap-3">
          ...
          <View>
            <Text className="text-slate-900 dark:text-white text-xl font-black">Manual Incomes</Text>
      ...
      >
        <View>
          ...
          <Text className="text-emerald-600 dark:text-emerald-400 font-black text-2xl mt-1">
        ...
        <FlatList
          ...
          ListEmptyComponent={
            ...
            >
              ...
              <Text className="text-slate-900 dark:text-zinc-300 font-bold text-sm">No incomes logged yet</Text>
        ...
        <View className="flex-1 bg-black/70 justify-end">
          <View className="bg-white dark:bg-zinc-900 border-t border-slate-200 dark:border-zinc-800 rounded-t-3xl p-5 max-h-[90%] shadow-2xl">
            <View className="flex-row items-center justify-between mb-4">
              <Text className="text-slate-900 dark:text-white font-black text-lg">Record Manual Income</Text>
              <Pressable
